...
export const visualPresets = {
  'editorial-paper': {
    label: 'Media Portal',
    mood: 'clear distribution authority',
    fontDirection: 'bold sans headlines with readable sans body',
    colors: {
      background: '#e7f1f5',
      foreground: '#26394f',
      muted: '#63727e',
    ...
    shape: 'blue mastheads, pale panels, green labels, and list-led modules',
  },
  'luxury-atelier': {
