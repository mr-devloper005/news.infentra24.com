...
const inputClass = 'h-[3.25rem] border border-[#b8cbd5] bg-white px-4 text-base font-bold text-[#26394f] outline-none transition placeholder:text-[#71808b] focus:border-[#4daf73]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center border border-[#2c5e9d] bg-[#2c5e9d] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-[#4daf73] disabled:opacity-60'
